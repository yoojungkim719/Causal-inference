...
for (nums in c(300, 500, 1000)) {
  ...
  eval(parse(text=paste0( "write.csv(RMSE, 'OBS result/rmse(", nums, ").csv'",", row.names=F)")))
  eval(parse(text=paste0( "write.csv(BIAS, 'OBS result/bias(", nums, ").csv'",", row.names=F)")))
  eval(parse(text=paste0( "write.csv(ites.sl, 'OBS result/ite.sl(", nums, ").csv'",", row.names=F)")))
  eval(parse(text=paste0( "write.csv(ites.tl, 'OBS result/ite.tl(", nums, ").csv'",", row.names=F)")))
  eval(parse(text=paste0( "write.csv(ites.xl, 'OBS result/ite.xl(", nums, ").csv'",", row.names=F)")))
  eval(parse(text=paste0( "write.csv(ites.drl, 'OBS result/ite.drl(", nums, ").csv'",", row.names=F)")))
  
  print(paste0("n=", nums, " completed"))
